...
module pcihellocore_mm_interconnect_0 (
	...
	wire  [112:0] pio_0_s1_agent_rp_data;                                                 // pio_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [112:0] router_004_src_data;                                                    // router_004:src_data -> pio_0_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                   // pio_0_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [4:0] router_004_src_channel;                                                 // router_004:src_channel -> pio_0_s1_rsp_width_adapter:in_channel
	...
	wire          pio_0_s1_rsp_width_adapter_src_valid;                                   // pio_0_s1_rsp_width_adapter:out_valid -> rsp_demux_003:sink_valid
	wire  [148:0] pio_0_s1_rsp_width_adapter_src_data;                                    // pio_0_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          pio_0_s1_rsp_width_adapter_src_ready;                                   // rsp_demux_003:sink_ready -> pio_0_s1_rsp_width_adapter:out_ready
	wire    [4:0] pio_0_s1_rsp_width_adapter_src_channel;                                 // pio_0_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	wire          pio_0_s1_rsp_width_adapter_src_startofpacket;                           // pio_0_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_003:sink_startofpacket
	wire          pio_0_s1_rsp_width_adapter_src_endofpacket;                             // pio_0_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_003:sink_endofpacket
	...
	wire          cmd_mux_003_src_valid;                                                  // cmd_mux_003:src_valid -> pio_0_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_003_src_data;                                                   // cmd_mux_003:src_data -> pio_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                  // pio_0_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                                // cmd_mux_003:src_channel -> pio_0_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_003_src_startofpacket;                                          // cmd_mux_003:src_startofpacket -> pio_0_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                            // cmd_mux_003:src_endofpacket -> pio_0_s1_cmd_width_adapter:in_endofpacket
	wire          pio_0_s1_cmd_width_adapter_src_valid;                                   // pio_0_s1_cmd_width_adapter:out_valid -> pio_0_s1_burst_adapter:sink0_valid
	wire  [112:0] pio_0_s1_cmd_width_adapter_src_data;                                    // pio_0_s1_cmd_width_adapter:out_data -> pio_0_s1_burst_adapter:sink0_data
